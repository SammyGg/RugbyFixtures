"""
Django settings for rfpj project.
...
SECRET_KEY = 'django-insecure-@=vtzl7--l8qp)!oqaof1d_=5tu7h-)!saypjm9&8b77!8-jyd'
...
WSGI_APPLICATION = 'rfpj.wsgi.application'
...
ADMINS = [("Matt", "mjgascoyne@hotmail.com")]
